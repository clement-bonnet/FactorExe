...
class ActorNetworks(NamedTuple):
    """Defines the actor networks, which outputs the logits of a policy given an observation.
...
def make_actor_networks_bin_pack(
    bin_pack: BinPack,

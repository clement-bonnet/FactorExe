...
- Study the scaling laws of factorized computation. How does performance on a simple computational task evolve as a function of model size, chain of thought length, and training data?

...
if __name__ == "__main__":
    ...
    run_cot_joint_transformer_exp(
        ...
        run_name="Cycle 1-30 RL bs_512 embed_12_16_4 ent_2e-3 joint_transformer T1",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        learning_rate=1e-4,
        cot_entropy_weight=2e-3,
        run_name="Cycle 1-30 RL bs_512 embed_9_24_4 ent_2e-3 joint_transformer T1",
    )
    run_augmented_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        learning_rate=1e-4,
        cot_entropy_weight=2e-3,
        run_name="Cycle 1-30 RL bs_512 embed_9_16_4 ent_2e-3 aug_transformer T1 dummy_encoder",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.SUPERVISED,
        ...
        learning_rate=1e-4,
        cot_entropy_weight=2e-3,
        run_name="Cycle 1-30 SUPERVISED bs_512 embed_9_16_4 ent_2e-3 joint_transformer T1",
    )

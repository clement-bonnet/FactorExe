...
if __name__ == "__main__":
    ...
    run_augmented_transformer_exp(
        ...
        cot_module_input_encoder_num_layers=0,
        ...
        run_name=("Cycle 1-10 RL T1 dummy_encoder"),
    )
    run_augmented_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        mlp_dim_factor=1,
        cot_entropy_weight=0.0,
        run_name=("Cycle 1-10 RL T2 dummy_encoder"),
    )
    run_augmented_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        mlp_dim_factor=1,
        cot_entropy_weight=0.0,
        run_name=("Cycle 1-10 RL T1+T1 dummy_encoder"),
    )
    run_augmented_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        mlp_dim_factor=1,
        cot_entropy_weight=0.0,
        run_name=("Cycle 1-10 RL T1+T2 dummy_encoder"),
    )

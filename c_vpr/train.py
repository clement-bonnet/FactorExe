...
if __name__ == "__main__":
    ...
    run_cot_joint_transformer_exp(
        ...
        batch_size=512,
        learning_rate=1e-4,
        run_name="Cycle 1-40 RL bs_512 embed_6_32_4 joint_transformer T1",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        batch_size=512,
        learning_rate=1e-4,
        run_name="Cycle 1-40 RL bs_512 embed_6_64_4 joint_transformer T1",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        batch_size=512,
        learning_rate=1e-4,
        run_name="Cycle 1-40 RL bs_512 embed_12_32_4 joint_transformer T1",
    )

...
if __name__ == "__main__":
    ...
    run_augmented_transformer_exp(
        ...
        run_name="Cycle 1-5 RL cot_entropy_weight_5e-1 T1 inputs_hidden dummy_encoder",
    )
    run_augmented_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        hide_inputs_from_encoder=True,
        dummy_encoder=True,
        cot_entropy_weight=1,
        run_name="Cycle 1-5 RL cot_entropy_weight_1e0 T1 inputs_hidden dummy_encoder",
    )
    # run_augmented_transformer_exp(
    #     env_name="Cycle",
    #     mode=MODE.RL,

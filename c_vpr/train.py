...
if __name__ == "__main__":
    ...
    run_augmented_transformer_exp(
        ...
        run_name="Cycle 1-10 RL baseline_10 bs_8192 lr_1e-4 T1 dummy_encoder",
    )
    run_augmented_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        learning_rate=6e-5,
        dummy_encoder=True,
        run_name="Cycle 1-15 RL bs_16384 lr_6e-5 T1 dummy_encoder",
    )
    run_augmented_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        dummy_encoder=True,
        rl_baseline_batch_size=10,
        run_name="Cycle 1-15 RL baseline_10 bs_16384 lr_6e-5 T1 dummy_encoder",
    )
    # run_augmented_transformer_exp(
    #     env_name="Cycle",
    #     mode=MODE.RL,

...
if __name__ == "__main__":
    ...
    run_cot_joint_transformer_exp(
        ...
        run_name="Cycle 1-30 RL bs_512 embed_6_16_4 ent_5e-3 joint_transformer T1",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        learning_rate=1e-4,
        cot_entropy_weight=5e-3,
        run_name="Cycle 1-30 RL bs_512 embed_6_16_4 ent_5e-3 joint_transformer T2",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        run_name="Cycle 1-30 RL bs_512 embed_6_16_4 ent_1e-2 joint_transformer T1",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
    ...
    run_cot_joint_transformer_exp(
        ...
        learning_rate=1e-4,
        cot_entropy_weight=2e-3,
        run_name="Cycle 1-30 RL bs_512 embed_9_16_4 ent_2e-3 joint_transformer T1",
    )

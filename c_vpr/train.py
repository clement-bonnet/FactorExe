...
if __name__ == "__main__":
    ...
    run_cot_joint_transformer_exp(
        ...
        run_name="Cycle 3-10 RL bs_512 embed_12_16_4 ent_2e-3 joint_transformer T2",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.RL,
        ...
        learning_rate=1e-4,
        cot_entropy_weight=2e-3,
        run_name="Cycle [1,2,3]-10 RL bs_512 embed_12_16_4 ent_2e-3 joint_transformer T2",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.SUPERVISED,
        ...
        run_name="Cycle 3-10 SUPERVISED bs_512 embed_12_16_4 joint_transformer T2",
    )
    run_cot_joint_transformer_exp(
        env_name="Cycle",
        mode=MODE.SUPERVISED,
        ...
        learning_rate=1e-4,
        cot_entropy_weight=0.0,
        run_name="Cycle [1,2,3]-10 SUPERVISED bs_512 embed_12_16_4 joint_transformer T2",
    )
